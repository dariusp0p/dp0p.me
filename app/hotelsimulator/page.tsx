...
export default function HotelSimulatorPage() {
  return (
    <main className="min-h-screen">
      <FloatingNav navItems={navItems} />
      <section className="min-h-[90vh] p-16">
        <h1 className="text-4xl font-bold mb-4">HotelSimulator</h1>
        <p>Details and demo for the HotelSimulator Python application.</p>
      </section>
      <Footer />
    </main>
  );
